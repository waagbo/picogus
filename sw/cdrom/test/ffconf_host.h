/*---------------------------------------------------------------------------/
/  Configurations of FatFs Module -- host test copy of sw/fatfs/source/ffconf.h
/  with FF_FS_READONLY 0, FF_FS_MINIMIZE 0 and FF_USE_MKFS 1 so the test can
/  format the RAM disk and create fixture files. Everything else (LFN length,
/  code page, FF_FS_RPATH 0, ...) must stay identical to the firmware.
/---------------------------------------------------------------------------*/
